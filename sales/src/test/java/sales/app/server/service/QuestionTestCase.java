...
public class QuestionTestCase {
    ...
    public void test1Save() {
        try {
            ...
            question.setQuestion("tHCVF12XNtq2lztmDk2p8DhG3DhSAIzuFo3OuIbcKjkKz8DCQJ");
            question.setQuestionDetails("C7a");
            question.setQuestionIcon("nVGrs7nQyuicOpLvpwgbFhMCJ9t9B8JQtyMtrbkAtN0sIITaaJ");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestion("6xuUBi60G0XNezkGO9KuJ45NEPiLG9DwCbys8NoIllOQjXsMOM");
            question.setQuestionDetails("X2B");
            question.setQuestionIcon("1qQpORZ3HsSLtaWY9Mp3zmtjxhk8D9oK96EJJWsmYYAigtrqns");
