...
Ext.define('Testp.view.reportui.datachart.chart.RatingField', {
	...
	onRender: function(ct, position) {
		Testp.view.reportui.datachart.chart.RatingField.superclass.onRender.call(this, ct, position);
	 ...
	 */
	initEvents: function() {
		Testp.view.reportui.datachart.chart.RatingField.superclass.initEvents.call(this);
