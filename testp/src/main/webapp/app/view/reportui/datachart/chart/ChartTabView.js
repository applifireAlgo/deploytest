Ext.define('Testp.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Testp.view.reportui.datachart.chart.RatingField','Testp.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
