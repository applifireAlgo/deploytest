Ext.define('Testp.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Testp.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Testp.view.console.ConsoleWindow');
