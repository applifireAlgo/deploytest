Ext.define("Testp.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Testp.view.clouddrive.CloudDriveController',
	             'Testp.view.clouddrive.documentview.DocumentsView',
	             'Testp.view.clouddrive.drivedetails.DriveDetails',
	             //'Testp.view.clouddrive.documentview.DocumentListView'
	             ],
