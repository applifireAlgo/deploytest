Ext.define('Testp.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Testp.view.usermanagement.enduser.UserProfileController', 'Testp.view.usermanagement.admin.AddUserDetailsViewModel', 'Testp.model.AddUserDataModel' ],
