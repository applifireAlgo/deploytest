Ext.define('Testp.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Testp.view.usermanagement.admin.UserPasswordReset',
	            'Testp.view.usermanagement.admin.AddUserDetails',
	            'Testp.view.usermanagement.admin.ViewUser'],
