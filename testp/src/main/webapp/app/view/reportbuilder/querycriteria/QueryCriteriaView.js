Ext.define('Testp.view.reportbuilder.querycriteria.QueryCriteriaView', {
	extend : 'Ext.grid.Panel',
	requires:['Testp.view.reportbuilder.querycriteria.QueryCriteriaController',
	          'Testp.store.QueryCriteriaWidgetsStore',
	          'Ext.grid.RowEditor',
	          'Testp.view.reportbuilder.querycriteria.QueryCriteriaModel'
	          ],
	...
	columns : [
				...
				},
				{
					...
					editor : {
						...
						store : 'Testp.store.QueryCriteriaWidgetsStore',
						queryMode : 'local',
						forceSelection : true,
						triggerAction : 'all',
						selectOnFocus : true,
