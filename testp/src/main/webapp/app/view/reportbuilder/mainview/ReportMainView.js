Ext.define('Testp.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Testp.view.reportbuilder.reportlist.ReportListPanelView',
             'Testp.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Testp.view.reportbuilder.mainview.ReportMainController'
             ],
