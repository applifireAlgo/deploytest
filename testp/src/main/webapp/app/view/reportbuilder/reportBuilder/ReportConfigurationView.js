Ext.define('Testp.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Testp.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Testp.view.reportbuilder.gridconfig.GridConfigView',
	           'Testp.view.reportbuilder.properties.PropertiesPanelView',
	           'Testp.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
