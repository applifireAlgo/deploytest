Ext.define('Testp.view.mainleftmenutree.MainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'mainPanelWithLeftMenu',

	requires : [ 'Testp.view.resource.ResourcePanel',
			'Testp.view.mainleftmenutree.TopPanel.TopPanel',
			'Ext.layout.container.Accordion', 'Ext.Img', 'Ext.button.Split',
			'Testp.view.resource.DockedResourcePanel','Testp.view.fw.mainViewPanel.MainPanelController' ],
