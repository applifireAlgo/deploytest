Ext.define('Testp.view.mainleftmenutree.TopPanel.TopPanelController', {
	...
	onSearchClick : function(button) {
		...
		//	"Testp.view.scheduler.scheduler"
		var component = Ext.create(
				"Testp.view.searchengine.search.SearchEngineMainPanel", {
					closable : true,
					title : "Search Engine",
					refId : "-1"
				});
	...
	{
		var component = Ext.create(
				"Testp.view.clouddrive.CloudDrive", {
					closable : true,
					title : "Cloud Drive",
					//refId : "-1"
				});
