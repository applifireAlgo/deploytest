...
Ext
		.define(
				'Testp.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Testp.view.logger.tabs.details.DetailsTab',
							'Testp.view.logger.tabs.fileconnector.FileConnectorTab',
							'Testp.view.logger.tabs.dbconnector.DBConnectorTab',
							'Testp.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Testp.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Testp.view.logger.LogConfigurationTabPanelController',
