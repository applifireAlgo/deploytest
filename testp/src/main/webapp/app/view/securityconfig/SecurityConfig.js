 ...
 * 
 */
Ext.define('Testp.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Testp.view.securityconfig.SecurityConfigController',
			'Testp.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
