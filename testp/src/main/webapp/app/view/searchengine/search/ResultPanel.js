Ext
		.define(
				'Testp.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Testp.view.searchengine.search.SearchEngineMainPanelController','Testp.view.searchengine.search.PanelHeaderField' ,'Testp.view.searchengine.search.ReportGridView','Testp.view.searchengine.search.ReportChartView','Testp.view.searchengine.search.documentView','Testp.view.searchengine.search.DouMeanView','Testp.view.googlemaps.map.MapPanel'],
