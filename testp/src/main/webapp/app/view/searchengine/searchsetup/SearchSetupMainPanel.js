 ...
 * 
 */
Ext.define('Testp.view.searchengine.searchsetup.SearchSetupMainPanel', 
{
	extend : 'Ext.panel.Panel',
	xtype : 'searchsetup',
	requires : [ 'Ext.layout.container.HBox', 'Ext.layout.container.VBox', 'Testp.view.searchengine.searchsetup.SearchSetupMainPanelController',
	             'Testp.view.searchengine.searchsetup.ChartFieldsModel',
	           ],
