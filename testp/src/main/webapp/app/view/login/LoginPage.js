Ext.define('Testp.view.login.LoginPage', {
	extend : 'Ext.panel.Panel',
	xtype : 'login',

	controller : 'login',
	requires : [ 'Testp.view.login.LoginPageController',
	             // 'Testp.view.login.LoginModel',
	             'Ext.form.Panel', 'Ext.button.Button', 'Ext.form.field.Text', 'Testp.view.main.MainPanel' ],
