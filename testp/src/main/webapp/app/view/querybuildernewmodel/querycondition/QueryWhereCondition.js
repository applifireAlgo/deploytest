Ext.define('Testp.view.querybuildernewmodel.querycondition.QueryWhereCondition', {
	extend : 'Ext.tree.TreePanel',
	requires:['Testp.view.querybuildernewmodel.querycondition.QueryWhereConditionController'],
