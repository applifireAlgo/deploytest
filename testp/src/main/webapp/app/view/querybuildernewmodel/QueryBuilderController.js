Ext.define('Testp.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Testp.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Testp.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Testp.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Testp.view.querybuildernewmodel.querydetail.QueryDetail');
