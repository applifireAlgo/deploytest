Ext.define('Testp.view.querybuildernewmodel.queryentities.QueryEntitiesTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Testp.view.querybuildernewmodel.queryentities.QueryEntitiesController'],
