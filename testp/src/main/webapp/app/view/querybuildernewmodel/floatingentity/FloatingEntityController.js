Ext.define('Testp.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Testp.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Testp.view.querybuildernewmodel.queryentitiesjoins.Query',
