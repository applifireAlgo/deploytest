 ...
 * 
 */
Ext.define('Testp.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Testp.view.logalarm.mainscreen.AddLogAlarmController',
			'Testp.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Testp.view.logalarm.mainscreen.AppAlarmPanel',
