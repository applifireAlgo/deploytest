 ...
 * 
 */
Ext.define('Testp.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Testp.view.logalarm.LogAlarmMainViewController',
			'Testp.view.logalarm.tree.LogAlarmTreePanel',
			'Testp.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
