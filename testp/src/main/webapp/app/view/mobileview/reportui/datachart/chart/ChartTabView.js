Ext.define('Testp.view.mobileview.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Testp.view.mobileview.reportui.datachart.chart.RatingField','Testp.view.mobileview.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
