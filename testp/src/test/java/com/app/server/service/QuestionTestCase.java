...
public class QuestionTestCase {
    ...
    public void test1Save() {
        try {
            ...
            question.setQuestion("0VJmVXMxeYaahYaH2VhtUHHEpNLalyI5RyKiCTsbPqMnprNq0H");
            question.setQuestionDetails("WGw");
            question.setQuestionIcon("HDhKjofnUaLFQZLRGUCz0xoAXVdSUNncNFYqDFEcKnM6lmloCE");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestion("4M3gLHn8qFmffg1zkTEVwMeMKYN10M8QEPhOahcZG6RuDbPx7e");
            question.setQuestionDetails("7iu");
            question.setQuestionIcon("HXMAgusZjAD4lTEMQ3baqvfiGgcS9fmdrN4SInJ80Qro1MQrBI");
