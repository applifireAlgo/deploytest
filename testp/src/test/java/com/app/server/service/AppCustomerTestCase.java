...
public class AppCustomerTestCase {
    ...
    public void test1Save() {
        try {
            ...
            appcustomercategory.setCustomerCategory("Zf3hFT4peHWhRCsoLCMHvYBxvg44jqptI0ReNmfwKw8RDaX8Ph");
            ...
            appcustomertype.setCustomerType("8mfGABtFGAzoZxO7qwdY2jOvwBcx8MUkk7NoVAQMgmL1Rx3eAl");
            ...
            corecontacts.setEmailId("m0Mwq01KVMiuEywjJIT9Lrclh1YcNgbuld9o6dfggRhOkTJjUK");
            corecontacts.setFirstName("zyF6VE3P4Qc0dac32oNr1ejemg4JjN5MVyGUP4ittvup8bU8nw");
            Gender gender = new Gender();
            gender.setGender("sRL1ivxb5b770PM7f2suzeEyca7vwrcD1etv8XkzbPsw9gryjc");
            Gender GenderTest = genderRepository.save(gender);
            map.put("GenderPrimaryKey", gender._getPrimarykey());
            Language language = new Language();
            language.setAlpha2("T5");
            language.setAlpha3("C93");
            language.setAlpha4("KSnJ");
            language.setAlpha4parentid(6);
            language.setLanguage("Ex4LqON4kLEGHbq4u7Ka8RuhxCJGWcsOS3JDtWcV410zivoS8k");
            language.setLanguageDescription("fw33PxJSMYALNXynFQTzmgIgtuTfLQYUetdyD2Q5Pgx4yBrYfc");
            language.setLanguageIcon("Ds07JeC2fhYly3KySXbwW42Blz7icPFxJ5DmZMffAUTpyUfWne");
            language.setLanguageType("G4LRG2ctRQNB90vWgUNW1IKgyv3BNqPE");
            Language LanguageTest = languageRepository.save(language);
            map.put("LanguagePrimaryKey", language._getPrimarykey());
            Timezone timezone = new Timezone();
            timezone.setCities("WXcNDYMhTrCwADyUG0euHlOdyw55hOuy3TH7q9q4w06PhT6avh");
            timezone.setCountry("6l5oA4mG0SOrvCBHwIpeOqToDNWiRehJa2y1Ck8ki1Ns1GedPl");
            timezone.setGmtLabel("X07FCTG5n4hBVG0YwRvQhqX82pYFY8vOdLtDqKB3fbLh5WlYFq");
            timezone.setTimeZoneLabel("2a3dY3g22K3IqOKIUWYaldQFv9sMz283PtRebz3VfdlGof8hAT");
            timezone.setUtcdifference(6);
            Title title = new Title();
            title.setTitles("4mrEkkEElyCQ28nFAqoQpmmEu9711zt874gyFHr6uabGZSP2eI");
            Title TitleTest = titleRepository.save(title);
            map.put("TitlePrimaryKey", title._getPrimarykey());
            corecontacts.setAge(58);
            corecontacts.setApproximateDOB(new java.sql.Date(123456789));
            corecontacts.setDateofbirth(new java.sql.Date(123456789));
            corecontacts.setEmailId("r6fr7EFOWA24G81Vob5QcNS3YnaFVdjMIGjsb4d2nc45J44zwP");
            corecontacts.setFirstName("Q9WgJmk1HPzt3OBr7EeYQSh79Xz0UisM4z13Ens0xlQ3UtdR0Q");
            corecontacts.setGenderId((java.lang.String) GenderTest._getPrimarykey()); /* ******Adding refrenced table data */
            corecontacts.setLastName("5vANUnpEVnMEGDm49G97omkG3TCR7eBSYe31TazsdhuBYLu8uc");
            corecontacts.setMiddleName("LhedZZ569ZKmDRJHq8ZUqLiFcQzkNYErFwCDi5ElOEBa7Mfp2r");
            corecontacts.setNativeFirstName("itK3PuE5bkvw1oJtZjX0wfUCLcZna0N8hliLnHhYFyVNU1rLFH");
            corecontacts.setNativeLanguageCode((java.lang.String) LanguageTest._getPrimarykey()); /* ******Adding refrenced table data */
            corecontacts.setNativeLastName("4vmEI2Fk7VFj17D9sWAtJRcuR959MJRmSnhg0sgZ9gr81BnKK5");
            corecontacts.setNativeMiddleName("et5eOxB3SiSjtkR9c7YLp2fCBEd3y3a3c2LO8p9lEFssDsnjbp");
            corecontacts.setNativeTitle("KJnTtITihEzk7WjXcUHg31Mp4QGAqlD3eBCKSlO2w1IZEV3Fh0");
            corecontacts.setPhoneNumber("jEDphPutEElSjfzvAD5X");
            ...
            appcustomer.setCustomerName("helgJfzm6Z9Iy2IxlEsev1Q5sJRVzwkBEk711mN8vcJGNM71yZ");
    ...
    public void test2Update() {
        try {
            ...
            appcustomer.setCustomerName("sgqQ0PFu3zGH1Eo5jcrHaMhEQ9Oyft4BSlPwdxCLkCUrTgjnsy");
