...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("kdjpdz9tNPa4cO5WxIkVEUm1fq0w59pX");
            country.setCapitalLatitude(1);
            country.setCapitalLongitude(2);
            country.setCountryCode1("Ynd");
            country.setCountryCode2("B9y");
            country.setCountryFlag("JGjd0czgEc9wA1Fb71S0jy1urr75GuaeBP46qPEwkaFuNqEDU1");
            country.setCountryName("yWJuw9wuS78AIX3kX0jimFDt1G5ZCLlLatE9CKstYI3EGpsZQ8");
            country.setCurrencyCode("e4j");
            country.setCurrencyName("Wpx4QNvvRuhi1dJungMXphCNsJ6WdYtgPQFNmG5SHBRWopsE6G");
            country.setCurrencySymbol("UUB7nk2pswrRDF6xpeGDFuXqrvuO7sqS");
            country.setIsoNumeric(10);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("xiKqjqjKe5izF06JZpbOldaE1jBBKE1Ci4eR7jRgEAJjuHjfl8");
            currency.setUnicodeDecimal("YIAEzMzYzF3G5iMfXigIUrKed7JGS1JUFWJMKOv5RYbdaxNDQo");
            currency.setUnicodeHex("VXI8FUrpI8DNDO2wNJV4pBeLtLP83RoY1WckKAXbYNSxtEpbO1");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("X8fAElCOVTEeiYRrQWTTZ8B16Kf0egDPxyP2hhFGQ2kPsFEWQA");
            currency.setUnicodeDecimal("D201oMDN7PlTHiV5aqrDcHDbfZWyLOLQDzPXpFm7TV9vdGDYI4");
            currency.setUnicodeHex("Ey7q6yDG27F34qzvI4RA4U1iPznQLgA0iHRXlAZHspg7Hd649v");
