...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("IZr88CinM5ZpjFxcUqEGJJar8TsbS93D");
            country.setCapitalLatitude(5);
            country.setCapitalLongitude(2);
            country.setCountryCode1("I1Q");
            country.setCountryCode2("Mfd");
            country.setCountryFlag("IiQkCKT6IMwcxK3yQYi1o21EhYpiiOWN9SxxgaPIJQP40qk0Ke");
            country.setCountryName("hidFHlCWLJkpavXdt6kOVIfqP889pzgNRDGPVMYZD1BZhamzBt");
            country.setCurrencyCode("rJX");
            country.setCurrencyName("yisiqgCVplPMcYfylnJDAjbevrFrVf2J60SEIt8olDSITS8FFt");
            country.setCurrencySymbol("yJRfGwDYBOR1sdTY5k4KAVqE5VlcKaaA");
            country.setIsoNumeric(1);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("hF18xFB6anpAUCiSj6jvf4WXqNJT6mvzLvqeclJDkxIOuSjgLQ");
            currency.setUnicodeDecimal("LZfXBw8FVOulVlgqXojCJvY0JkP7Yz7bRwfZS50iIbdbNc3WGb");
            currency.setUnicodeHex("dIcd8nGb5jwmVsoznEFXWyPZgNWCfirAtYlxT4itBrbQAbkl8x");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("EodlwLtJX9OVEXdGmlGJbHrfoUMH7gcJcIM85i8yLTtaL25YT7");
            currency.setUnicodeDecimal("T4bCuT1FIdATu7ugzNT0aZTzSEWK40sPoeOe3FWEJzeBzyAQS9");
            currency.setUnicodeHex("FHtXeXFBC3b0IIRn0m1rA4Th13cOAk3r7GDre3ug6Zb3uleCFV");
