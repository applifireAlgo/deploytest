Ext.define('Testproj.view.querybuildernewmodel.querystructure.QueryStructureController', {
	...
	init:function(){
		...
		this.queryStructreStore = Ext.create('Testproj.view.querybuildernewmodel.querystructure.QueryStructureStore');
	...
	afterrender :function( tree,eOpts ){
		...
		var rootChildNodes = root.childNodes;
				...
				for (var q = 0; q < rootChildNodes.length; q++) {
					...
					var model = Ext.create('Testproj.view.querybuildernewmodel.querystructure.QueryStructureModel');
