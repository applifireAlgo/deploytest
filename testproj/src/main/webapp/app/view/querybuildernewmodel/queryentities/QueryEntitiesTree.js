Ext.define('Testproj.view.querybuildernewmodel.queryentities.QueryEntitiesTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Testproj.view.querybuildernewmodel.queryentities.QueryEntitiesController'],
