Ext.define('Testproj.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Testproj.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Testproj.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Testproj.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Testproj.view.querybuildernewmodel.querydetail.QueryDetail');
