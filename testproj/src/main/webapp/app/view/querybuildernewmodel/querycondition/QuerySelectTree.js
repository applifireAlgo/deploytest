Ext.define('Testproj.view.querybuildernewmodel.querycondition.QuerySelectTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Testproj.view.querybuildernewmodel.querycondition.QuerySelectController',
