Ext
		.define(
				'Testproj.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Testproj.view.searchengine.search.SearchEngineMainPanelController','Testproj.view.searchengine.search.PanelHeaderField' ,'Testproj.view.searchengine.search.ReportGridView','Testproj.view.searchengine.search.ReportChartView','Testproj.view.searchengine.search.documentView','Testproj.view.searchengine.search.DouMeanView','Testproj.view.googlemaps.map.MapPanel'],
