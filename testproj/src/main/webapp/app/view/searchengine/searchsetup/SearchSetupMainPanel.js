 ...
 * 
 */
Ext.define('Testproj.view.searchengine.searchsetup.SearchSetupMainPanel', 
{
	extend : 'Ext.panel.Panel',
	xtype : 'searchsetup',
	requires : [ 'Ext.layout.container.HBox', 'Ext.layout.container.VBox', 'Testproj.view.searchengine.searchsetup.SearchSetupMainPanelController',
	             'Testproj.view.searchengine.searchsetup.ChartFieldsModel',
	           ],
