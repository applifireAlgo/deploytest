 ...
 * 
 */
Ext.define('Testproj.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Testproj.view.securityconfig.SecurityConfigController',
			'Testproj.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
