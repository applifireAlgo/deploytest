Ext.define('Testproj.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Testproj.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Testproj.view.console.ConsoleWindow');
