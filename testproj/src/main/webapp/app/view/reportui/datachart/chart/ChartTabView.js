Ext.define('Testproj.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Testproj.view.reportui.datachart.chart.RatingField','Testproj.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
