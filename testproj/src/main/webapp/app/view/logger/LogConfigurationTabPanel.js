...
Ext
		.define(
				'Testproj.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Testproj.view.logger.tabs.details.DetailsTab',
							'Testproj.view.logger.tabs.fileconnector.FileConnectorTab',
							'Testproj.view.logger.tabs.dbconnector.DBConnectorTab',
							'Testproj.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Testproj.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Testproj.view.logger.LogConfigurationTabPanelController',
