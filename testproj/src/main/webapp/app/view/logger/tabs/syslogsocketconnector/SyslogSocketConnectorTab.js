 ...
 * 
 */
Ext.define('Testproj.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Testproj.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
