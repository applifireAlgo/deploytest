...
Ext
		.define(
				'Testproj.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
				{
					...
					requires : [ 'Testproj.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTabController' ],
