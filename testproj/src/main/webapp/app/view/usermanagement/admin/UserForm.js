Ext.define('Testproj.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Testproj.view.usermanagement.admin.AddUserDetailsViewModel', 'Testproj.model.AddUserDataModel' ],
