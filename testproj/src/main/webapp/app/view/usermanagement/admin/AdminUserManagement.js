Ext.define('Testproj.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Testproj.view.usermanagement.admin.UserPasswordReset',
	            'Testproj.view.usermanagement.admin.AddUserDetails',
	            'Testproj.view.usermanagement.admin.ViewUser'],
