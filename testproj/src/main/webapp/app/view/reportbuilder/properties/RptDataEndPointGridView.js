Ext.define('Testproj.view.reportbuilder.properties.RptDataEndPointGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Testproj.view.reportbuilder.properties.RptDataEndPointGridController'],
