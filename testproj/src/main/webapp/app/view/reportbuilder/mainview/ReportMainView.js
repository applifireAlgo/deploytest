Ext.define('Testproj.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Testproj.view.reportbuilder.reportlist.ReportListPanelView',
             'Testproj.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Testproj.view.reportbuilder.mainview.ReportMainController'
             ],
