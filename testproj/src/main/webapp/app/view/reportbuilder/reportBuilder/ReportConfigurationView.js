Ext.define('Testproj.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Testproj.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Testproj.view.reportbuilder.gridconfig.GridConfigView',
	           'Testproj.view.reportbuilder.properties.PropertiesPanelView',
	           'Testproj.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
