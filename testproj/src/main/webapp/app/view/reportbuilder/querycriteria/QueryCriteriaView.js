Ext.define('Testproj.view.reportbuilder.querycriteria.QueryCriteriaView', {
	extend : 'Ext.grid.Panel',
	requires:['Testproj.view.reportbuilder.querycriteria.QueryCriteriaController',
	          'Testproj.store.QueryCriteriaWidgetsStore',
	          'Ext.grid.RowEditor',
	          'Testproj.view.reportbuilder.querycriteria.QueryCriteriaModel'
	          ],
	...
	columns : [
				...
				},
				{
					...
					editor : {
						...
						store : 'Testproj.store.QueryCriteriaWidgetsStore',
						queryMode : 'local',
						forceSelection : true,
						triggerAction : 'all',
						selectOnFocus : true,
