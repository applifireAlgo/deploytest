Ext.define('Testproj.view.mainleftmenutree.MainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'mainPanelWithLeftMenu',

	requires : [ 'Testproj.view.resource.ResourcePanel',
			'Testproj.view.mainleftmenutree.TopPanel.TopPanel',
			'Ext.layout.container.Accordion', 'Ext.Img', 'Ext.button.Split',
			'Testproj.view.resource.DockedResourcePanel','Testproj.view.fw.mainViewPanel.MainPanelController' ],
