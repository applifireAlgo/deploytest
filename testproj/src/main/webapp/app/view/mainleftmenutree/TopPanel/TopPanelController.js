Ext.define('Testproj.view.mainleftmenutree.TopPanel.TopPanelController', {
	...
	onSearchClick : function(button) {
		...
		//	"Testproj.view.scheduler.scheduler"
		var component = Ext.create(
				"Testproj.view.searchengine.search.SearchEngineMainPanel", {
					closable : true,
					title : "Search Engine",
					refId : "-1"
				});
	...
	{
		var component = Ext.create(
				"Testproj.view.clouddrive.CloudDrive", {
					closable : true,
					title : "Cloud Drive",
					//refId : "-1"
				});
