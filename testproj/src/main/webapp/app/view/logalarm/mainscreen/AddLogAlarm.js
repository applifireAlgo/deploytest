 ...
 * 
 */
Ext.define('Testproj.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Testproj.view.logalarm.mainscreen.AddLogAlarmController',
			'Testproj.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Testproj.view.logalarm.mainscreen.AppAlarmPanel',
