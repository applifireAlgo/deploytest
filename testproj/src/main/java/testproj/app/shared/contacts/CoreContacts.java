package testproj.app.shared.contacts;
...
import testproj.app.shared.EntityAudit;
import testproj.app.shared.SystemInfo;
...
public class CoreContacts implements Serializable, CommonEntityInterface, CoreContactsInterface, Comparator<CoreContacts> {
    ...
    public CoreContacts addAddress(Address _address) {
        if (this.address == null) {
            this.address = new java.util.ArrayList<testproj.app.shared.location.Address>();
        }
        if (_address != null) {
    ...
    public CoreContacts addCommunicationData(CommunicationData _communicationData) {
        if (this.communicationData == null) {
            this.communicationData = new java.util.ArrayList<testproj.app.shared.contacts.CommunicationData>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            testproj.app.shared.contacts.CoreContacts other = (testproj.app.shared.contacts.CoreContacts) obj;
            if (contactId == null) {
                return false;
