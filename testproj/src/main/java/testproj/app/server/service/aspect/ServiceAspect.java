package testproj.app.server.service.aspect;
...
public class ServiceAspect {
    ...
    @Pointcut("execution(* testproj.app.server.service..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* testproj.app.server.service..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* testproj.app.server.service..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* testproj.app.server.service..*..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* testproj.app.server.service..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* testproj.app.server.service..get*(..))")
