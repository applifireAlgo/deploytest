package testproj.app.server.repository.aspect;
...
public class RepositoryAspect {
    ...
    @Pointcut("execution(* testproj.app.server.repository..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* testproj.app.server.repository..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* testproj.app.server.repository..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* testproj.app.server.repository..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* testproj.app.server.repository..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* testproj.app.server.repository..*(..))")
